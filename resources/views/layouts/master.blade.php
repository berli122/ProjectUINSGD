...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('tamplate/stisla/dist/assets/modules/weather-icon/css/weather-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('tamplate/stisla/dist/assets/modules/weather-icon/css/weather-icons-wind.min.css') }}">
...
<body>
    ...
    <!-- JS Libraies -->
    @yield('page-script')
    <script src="{{ asset('tamplate/stisla/dist/assets/modules/prism/prism.js') }}"></script>
    ...
    <script src="{{ asset('tamplate/stisla/dist/assets/js/page/bootstrap-modal.js') }}"></script>
